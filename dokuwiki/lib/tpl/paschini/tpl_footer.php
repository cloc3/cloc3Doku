...
<div id="dokuwiki__footer"><div class="pad">
	...
	<a <?php echo $tgt?> href="http://www.itccarli.it/dokuwiki/doku.php?id=istruzioni"><img
	    src="<?php echo tpl_basedir(); ?>images/sintassi-dw.png" width="80" height="15" alt="Sintassi Dokuwiki in italiano" /></a>
    </div>
</div></div><!-- /footer -->
